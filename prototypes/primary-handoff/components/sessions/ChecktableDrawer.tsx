...
import { GridFilterBar, Legend } from "@/components/checktable/ChecktableApp";
...
export function ChecktableDrawer({ student, focusItemId, onClose }: Props) {
  ...
  // Same write paths as ChecktableApp so the drawer mutates the shared
  // store identically — closing the drawer leaves no state divergence.
  const handleAssign = (
    item: ChecktableItem,
    input: {
      pageRange?: string;

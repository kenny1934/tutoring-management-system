...
CONFIG_2026 = {
    ...
    "text_content": json.dumps({
        ...
        "intro_en": "This form collects your preferred class times. The final timetable will be based on the times that suit most students.",
        ...
        "disclaimer_en": "The final schedule will be based on the times that suit most students. We apologise if your preferred time slot cannot be offered.",
        "contact_by_date": "2026-08-18",
        ...
        "makeup_note_en": "If the student cannot attend a lesson during the paid lesson block, please notify the tutor in advance so a make-up lesson can be arranged as early as possible.",
    }),

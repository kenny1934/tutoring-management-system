      ...
      {previewLoading ? (
        ...
        <div className="space-y-4">
                  ...
                  <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
                    {preview.updatable_sessions.map((session) => (
                      <tr
                        ...
                        className={cn(
                          session.is_holiday && "bg-amber-50/50 dark:bg-amber-900/10"
                        )}
                      >
                        <td className="px-3 py-1.5">
                          ...
                          {session.is_holiday ? (
                            <div>
                              ...
                              <div className="font-medium text-amber-600 dark:text-amber-400">
                                {session.shifted_date ? formatShortDate(session.shifted_date) : formatShortDate(session.new_date)}
                              </div>
          ...
          {preview.updatable_sessions.length > 0 && (
            <div className="text-xs text-foreground/60 flex items-center gap-4 pt-2 border-t border-gray-200 dark:border-gray-700">
              <div className="flex items-center gap-1">

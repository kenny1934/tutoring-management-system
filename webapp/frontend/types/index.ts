...
export interface SummerSlotPlacementInfo {
  id: number;
...
export interface SummerSlot {
  ...
  placements: SummerSlotPlacementInfo[];
}
...
// ---- Summer Placement Types ----

export interface SummerPlacement {
  id: number;
  application_id: number;
  slot_id: number;
...
export interface SummerPlacementCreate {
  application_id: number;
  slot_id: number;
}

export interface SummerPlacementUpdate {
  placement_status: string;
}
...
export interface SummerSuggestionItem {
  ...
  slot_day: string;
  slot_time: string;
  slot_grade?: string | null;
  slot_label?: string | null;
  match_type: "first_pref" | "second_pref" | "any_open";
  confidence: number;
  reason: string;
}
...
export interface SummerApplication {
  ...
  reviewed_at?: string | null;
  form_language?: string | null;
  placements?: SummerApplicationPlacementInfo[];
}

export interface SummerApplicationPlacementInfo {
  id: number;
  slot_id: number;
  slot_day: string;
  time_slot: string;
...
export interface SummerSessionUpdate {
  lesson_number?: number;
  session_status?: "Scheduled" | "Attended" | "Cancelled";
  notes?: string;
}

export interface SummerSessionCalendarEntry {
  session_id: number;
  slot_id: number;
  slot_day: string;
  time_slot: string;
...
export interface SummerSessionCalendarResponse {
  week_start: string;
  week_end: string;
  sessions: SummerSessionCalendarEntry[];
}

...
export const documentsAPI = {
  list(params?: { doc_type?: string; search?: string; include_archived?: boolean; archived_only?: boolean; starred_only?: boolean; is_template?: boolean; sort_by?: string; sort_order?: string; limit?: number; offset?: number; tag?: string; folder_id?: number; my_docs?: boolean; ids?: string }) {
  ...
  toggleStar(id: number) {
    return fetchAPI<{ is_starred: boolean }>(
      `/documents/${id}/star`,
      { method: "POST" }
    );
  },
